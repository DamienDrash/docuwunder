...
(function (global) {
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    ...
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Automatisierungen</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    ...
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.autoRows || []).map((a, aIdx) => html`<div key=${a && a.id != null ? a.id : aIdx} style=${stil('display:flex;align-items:center;gap:12px;padding:12px 16px;position:relative')}>
          <div onClick=${a.open} style=${stil('flex:1;min-width:0;cursor:pointer')}><div style=${stil('font-size:15.5px;font-weight:600')}>${a.name}</div><div style=${stil('font-size:12.5px;color:var(--lab2);margin-top:2px')}>${a.verlauf}</div></div>
  ...
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;padding:12px 16px;display:flex;justify-content:space-between;align-items:center')}>
      <div><div style=${stil('font-size:15.5px;font-weight:600')}>Aktiv</div><div style=${stil('font-size:12.5px;color:var(--lab2)')}>${v.adVerlauf}</div></div>
      <div onClick=${v.adToggle} style=${stil(v.adTgBg)}><div style=${stil(v.adTgKnob)}></div></div>
    </div>
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Wenn</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;padding:12px 16px')}>
      <div style=${stil('font-size:15px;font-weight:500')}>${v.adAusl}</div>
    </div>
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Und</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.adBed || []).map((b, bIdx) => html`<div key=${b && b.id != null ? b.id : bIdx} style=${stil('padding:12px 16px;font-size:15px;position:relative')}>${b.t}<div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>`)}
    </div>
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Dann</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.adAkt || []).map((b, bIdx) => html`<div key=${b && b.id != null ? b.id : bIdx} style=${stil('padding:12px 16px;font-size:15px;position:relative')}>${b.t}<div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>`)}
    </div>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>E-Mail-Import</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;padding:14px 16px')}>
      <div style=${stil('display:flex;align-items:center;gap:12px')}>
        ...
        <div style=${stil('flex:1;min-width:0')}><div style=${stil('font-size:15.5px;font-weight:600')}>${v.kontoMail}</div><div style=${stil('display:flex;align-items:center;gap:5px;margin-top:2px')}><span style=${stil('width:7px;height:7px;border-radius:50%;background:var(--grn)')}></span><span style=${stil('font-size:13px;color:var(--lab2)')}>imap.gmx.net · Verbunden</span></div></div>
      </div>
    ...
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Regeln</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.mailRules || []).map((r, rIdx) => html`<div key=${r && r.id != null ? r.id : rIdx} style=${stil('display:flex;align-items:center;gap:12px;padding:12px 16px;position:relative')}>
          <div style=${stil('flex:1;min-width:0')}><div style=${stil('font-size:15.5px;font-weight:600')}>${r.name}</div><div style=${stil('font-size:12.5px;color:var(--lab2);margin-top:2px')}>${r.desc}</div></div>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Einstellungen</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 50px')}>
    ...
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Darstellung</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden;padding:12px 16px')}>
      ...
      <div onClick=${v.toggleDefView} style=${stil('display:flex;justify-content:space-between;align-items:center;padding:13px 0 6px;cursor:pointer')}><span style=${stil('font-size:15.5px')}>Standardansicht</span><span style=${stil('font-size:15px;color:var(--lab2)')}>${v.defViewLabel}</span></div>
      <div onClick=${v.doDynType} style=${stil('display:flex;justify-content:space-between;align-items:center;padding:10px 0 2px;cursor:pointer')}><span style=${stil('font-size:15.5px')}>Textgröße</span><span style=${stil('font-size:15px;color:var(--lab2)')}>Systemeinstellung</span></div>
    </div>
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Verbindung</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      <div style=${stil('display:flex;justify-content:space-between;align-items:center;padding:11px 16px;position:relative')}><span style=${stil('font-size:15.5px')}>Server</span><span style=${stil('font-size:14px;color:var(--lab2)')}>${v.serverAddr}</span><div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>
      <div style=${stil('display:flex;justify-content:space-between;align-items:center;padding:11px 16px;position:relative')}><span style=${stil('font-size:15.5px')}>Status</span><span style=${stil('display:flex;align-items:center;gap:6px;font-size:15px;color:var(--lab2)')}><span style=${stil('width:7px;height:7px;border-radius:50%;background:var(--grn)')}></span>Verbunden</span><div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>
      <div onClick=${v.switchServer} style=${stil('padding:12px 16px;cursor:pointer;position:relative')}><span style=${stil('font-size:15.5px;color:var(--acc)')}>Server wechseln</span><div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>
    ...
    <div style=${stil('background:var(--card);border-radius:16px;margin:14px 16px 0;overflow:hidden')}>
      <div onClick=${v.doHelp} style=${stil('padding:12px 16px;cursor:pointer;position:relative')}><span style=${stil('font-size:15.5px')}>Hilfe & Support</span><div style=${stil('position:absolute;left:16px;right:0;bottom:0;height:0.5px;background:var(--sep)')}></div></div>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Systemstatus</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.statusRows || []).map((r, rIdx) => html`<div key=${r && r.id != null ? r.id : rIdx} style=${stil('display:flex;justify-content:space-between;align-items:center;padding:11px 16px;position:relative')}>
          <span style=${stil('font-size:15px;color:var(--lab2)')}>${r.k}</span>
    ...
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Protokoll</div>
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;padding:12px 16px')}>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Verarbeitung</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    ...
    ${v.tasksEmpty ? html`<div style=${stil('padding:60px 40px;text-align:center')}>
        <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="var(--lab3)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" style=${stil('margin:0 auto;display:block')}><circle cx="12" cy="12" r="8.2"></circle><path d="M12 7.5V12l3 2"></path></svg>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Benutzer & Gruppen</div>
    <div onClick=${v.mitgliedNeu} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round"><path d="M12 5v14M5 12h14"></path></svg></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    ...
    <div style=${stil('font-size:13px;font-weight:600;color:var(--lab2);text-transform:uppercase;letter-spacing:0.3px;padding:18px 20px 8px')}>Gruppen</div>
    ...
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.gruppenRows || []).map((g, gIdx) => html`<div key=${g && g.id != null ? g.id : gIdx} onClick=${g.tap} style=${stil('display:flex;align-items:center;gap:12px;padding:12px 16px;position:relative;cursor:pointer')}>
          ...
          <div style=${stil('flex:1;min-width:0')}><div style=${stil('font-size:15.5px;font-weight:600')}>${g.name}</div><div style=${stil('font-size:12.5px;color:var(--lab2);margin-top:1px')}>${g.detail}</div></div>
