...
(function (global) {
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    ...
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>${v.listeTitle}</div>
  ...
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    ...
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.listeRows || []).map((d, dIdx) => html`<div key=${d && d.id != null ? d.id : dIdx} onClick=${d.open} style=${stil('display:flex;align-items:center;gap:11px;padding:10px 16px;cursor:pointer;position:relative')}>
          <div style=${stil('width:40px;height:52px;border-radius:6px;background:var(--pg);border:0.5px solid var(--sep);padding:7px 6px;display:flex;flex-direction:column;gap:3.5px;flex-shrink:0')}><div style=${stil('height:3px;width:65%;background:var(--pgl);border-radius:2px')}></div><div style=${stil('height:3px;width:90%;background:var(--pgl);border-radius:2px')}></div><div style=${stil('height:3px;width:75%;background:var(--pgl);border-radius:2px')}></div></div>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>${v.orgTitle}</div>
    <div onClick=${v.orgAdd} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round"><path d="M12 5v14M5 12h14"></path></svg></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    <div style=${stil('font-size:12.5px;color:var(--lab3);padding:0 20px 10px')}>${v.orgHint}</div>
    ${v.ordnerAn ? html`<div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
        ${(v.ordnerListe || []).map((f, fIdx) => html`<div key=${f && f.id != null ? f.id : fIdx} onClick=${f.tap} style=${stil('display:flex;align-items:center;gap:11px;padding:12px 16px;cursor:pointer;position:relative')}>
        ...
        ${(v.ordnerDateien || []).map((d, dIdx) => html`<div key=${d && d.id != null ? d.id : dIdx} onClick=${d.open} style=${stil('display:flex;align-items:center;gap:11px;padding:12px 16px;cursor:pointer;position:relative')}>
      ...
      ${v.ordnerLeer ? html`<div style=${stil('padding:60px 40px;text-align:center')}>
          <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="var(--lab3)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" style=${stil('margin:0 auto;display:block')}><path d="M3.5 6.5h6l2 2.5h9V19h-17z"></path></svg>
    ...
    ${v.ordnerAus ? html`<div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.orgList || []).map((o, oIdx) => html`<div key=${o && o.id != null ? o.id : oIdx} onClick=${o.tap} style=${stil('display:flex;align-items:center;gap:11px;padding:12px 16px;cursor:pointer;position:relative')}>
  ...
  <div style=${stil('position:absolute;top:0;left:0;right:0;z-index:6;display:flex;align-items:center;gap:10px;padding:60px 16px 8px;background:linear-gradient(var(--bg) 55%,transparent)')}>
    <div onClick=${v.popPush} style=${stil('width:36px;height:36px;border-radius:50%;background:var(--glass);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border:0.5px solid var(--gbor);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0')}><svg width="10" height="17" viewBox="0 0 10 17" fill="none" stroke="var(--acc)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 1.5L1.5 8.5l7 7"></path></svg></div>
    <div style=${stil('flex:1;text-align:center;font-size:15.5px;font-weight:600')}>Papierkorb</div>
    <div style=${stil('width:36px;flex-shrink:0')}></div>
  </div>
  <div style=${stil('position:absolute;inset:0;overflow-y:auto;padding:112px 0 40px')}>
    ...
    ${v.trashEmpty ? html`<div style=${stil('padding:70px 40px;text-align:center')}>
        <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="var(--lab3)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" style=${stil('margin:0 auto;display:block')}><path d="M4.5 6.5h15"></path><path d="M8.5 6.2V4.5h7v1.7"></path><path d="M6.5 6.5l1 14h9l1-14"></path></svg>
    ...
    <div style=${stil('background:var(--card);border-radius:16px;margin:0 16px;overflow:hidden')}>
      ${(v.trashRows || []).map((d, dIdx) => html`<div key=${d && d.id != null ? d.id : dIdx} style=${stil('padding:12px 16px;position:relative')}>
          <div style=${stil('font-size:15.5px;font-weight:600')}>${d.titel}</div>
