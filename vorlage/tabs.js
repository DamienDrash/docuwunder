...
(function (global) {
  ...
  ${v.viewIsGrid ? html`<div style=${stil('display:grid;grid-template-columns:1fr 1fr;gap:12px;padding:0 16px')}>
      ${(v.visDocs || []).map((d, dIdx) => html`<div key=${d && d.id != null ? d.id : dIdx} onClick=${d.tap} style=${stil('background:var(--card);border-radius:14px;padding:10px;cursor:pointer;position:relative')}>
          <div style=${stil('height:118px;border-radius:8px;background:var(--pg);border:0.5px solid var(--sep);padding:14px 12px;display:flex;flex-direction:column;gap:6px')}><div style=${stil('height:4px;width:50%;background:var(--pgl);border-radius:2px')}></div><div style=${stil('height:4px;width:85%;background:var(--pgl);border-radius:2px')}></div><div style=${stil('height:4px;width:70%;background:var(--pgl);border-radius:2px')}></div><div style=${stil('height:4px;width:80%;background:var(--pgl);border-radius:2px;margin-top:10px')}></div><div style=${stil('height:4px;width:65%;background:var(--pgl);border-radius:2px')}></div></div>
